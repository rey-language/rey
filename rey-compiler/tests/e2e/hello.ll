...
@.str0 = private unnamed_addr constant [23 x i8] c"Hello from native Rey!\00", align 1

define void @_rey_main() {
entry:
%t0 = call i8* @rey_str_new(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str0, i64 0, i64 0), i64 22)
call void @rey_println(i8* %t0)
ret void
}
