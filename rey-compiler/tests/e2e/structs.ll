...
%t1 = bitcast i8* null to %struct.Point*
%t2 = getelementptr %struct.Point, %struct.Point* %t1, i64 1
%t3 = ptrtoint %struct.Point* %t2 to i64
%t4 = add i64 %t3, 16
%t5 = call i8* @rey_alloc(i64 %t4)
store i8 8, i8* %t5
%t6 = getelementptr i8, i8* %t5, i64 16
%t0 = bitcast i8* %t6 to %struct.Point*
%t7 = getelementptr inbounds %struct.Point, %struct.Point* %t0, i32 0, i32 0
store i64 0, i64* %t7
%t8 = getelementptr inbounds %struct.Point, %struct.Point* %t0, i32 0, i32 1
store i64 0, i64* %t8
%t9 = getelementptr inbounds %struct.Point, %struct.Point* %t0, i32 0, i32 0
store i64 2, i64* %t9
%t10 = getelementptr inbounds %struct.Point, %struct.Point* %t0, i32 0, i32 1
store i64 3, i64* %t10
store %struct.Point* %t0, %struct.Point** %p.addr
%t11 = load %struct.Point*, %struct.Point** %p.addr
%t12 = getelementptr inbounds %struct.Point, %struct.Point* %t11, i32 0, i32 0
%t13 = load i64, i64* %t12
%t14 = load %struct.Point*, %struct.Point** %p.addr
%t15 = getelementptr inbounds %struct.Point, %struct.Point* %t14, i32 0, i32 1
%t16 = load i64, i64* %t15
%t17 = add i64 %t13, %t16
%t18 = call i8* @rey_int_to_str(i64 %t17)
