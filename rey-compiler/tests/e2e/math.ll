...
@.str0 = private unnamed_addr constant [4 x i8] c"big\00", align 1
@.str1 = private unnamed_addr constant [6 x i8] c"small\00", align 1
...
store i64 10, i64* %a.addr
store i64 3, i64* %b.addr
%t0 = load i64, i64* %a.addr
%t1 = mul i64 %t0, 2
%t2 = load i64, i64* %b.addr
%t3 = add i64 %t1, %t2
store i64 %t3, i64* %c.addr
%t4 = load i64, i64* %c.addr
%t5 = call i8* @rey_int_to_str(i64 %t4)
call void @rey_println(i8* %t5)
%t6 = load i64, i64* %c.addr
%t7 = icmp sgt i64 %t6, 20
br i1 %t7, label %then8, label %else9
then8:
%t11 = call i8* @rey_str_new(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str0, i64 0, i64 0), i64 3)
call void @rey_println(i8* %t11)
br label %endif10
else9:
%t12 = call i8* @rey_str_new(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str1, i64 0, i64 0), i64 5)
