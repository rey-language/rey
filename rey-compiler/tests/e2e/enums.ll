...
@.str0 = private unnamed_addr constant [4 x i8] c"red\00", align 1
@.str1 = private unnamed_addr constant [8 x i8] c"not red\00", align 1

define void @_rey_main() {
entry:
%c.addr = alloca i64, align 8
store i64 1, i64* %c.addr
%t0 = load i64, i64* %c.addr
%t1 = icmp eq i64 %t0, 0
br i1 %t1, label %then2, label %else3
then2:
%t5 = call i8* @rey_str_new(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str0, i64 0, i64 0), i64 3)
call void @rey_println(i8* %t5)
br label %endif4
else3:
%t6 = call i8* @rey_str_new(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str1, i64 0, i64 0), i64 7)
